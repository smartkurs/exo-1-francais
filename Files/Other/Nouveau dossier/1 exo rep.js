...
function initShortQuestion() {
 qstHead[0]="Ecoutez et répondez   ";
 qstHead[1]="2 Associez les questions et les réponses.  exemple: Votre nationalité ?   J...";
 qstHead[2]="3 Associez les éléments pour formre des phrases.  exemple: je m'appelle Dim...";
 qstHead[3]="4 Ecoutez et écrivez les noms.    ";
 qstHead[4]="Ecoutez les dialogues. Identifiez sur les dessins quelles personnes disent ...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,4,4,4);
